# NeuralBridge Companion App

Android app providing AI-native automation capabilities via AccessibilityService. Enables sub-100ms UI control for AI agents through binary protobuf protocol.
...
7. **NotificationListener** (`notification/`)
...
│   ├── proto/                    # Protobuf schema (copied from mcp-server)
│   └── res/                      # Resources
│       ├── values/strings.xml
...
```bash
# Copies proto from mcp-server and generates Kotlin code
...
**TCP server not reachable:**
- Verify service is running: Check notification
- Port forwarding: `adb forward tcp:38472 tcp:38472`
